...
const ProductsSection = () => {
    ...
    const products = [
        ...
        },
        {
            ...
            description: "Компания MaxMetal (Бишкек) изготавливает и устанавливает лестницы для бассейнов из нержавеющей стали - как для частных объектов, так и для коммерческих (отели, спортивные комплексы, пансионаты). Наши лестницы установлены во многих бассейнов города Бишкек! А также на Иссык-Куле.",
            icon: <PoolIcon />,
