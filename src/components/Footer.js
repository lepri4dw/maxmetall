...
const Footer = () => {
  ...
  const handleInstagramClick = () => {
    window.open('https://instagram.com/maxmetall_kg', '_blank');
  };
    ...
    >
      <Container maxWidth="lg">
        <Grid container spacing={{ xs: 3, md: 4 }}>
          ...
          <Grid item xs={12} md={4}>
            <Stack spacing={2}>
              ...
              >
                Изделия из нержавеющей стали премиум класса. 
        ...
        >
          ...
          >
            Изделия из нержавеющей стали премиум класса в Бишкеке
          </Typography>
        </Box>
      </Container>
    </Box>
