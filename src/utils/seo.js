...
const COMPANY_SEO = {
  ...
  description: 'Нержавейка в Бишкеке, Кыргызстане. Производство изделий из нержавеющей стали: перила, ограждения, лестницы для бассейнов, карнизы, поручни ЛОВЗ, флагштоки. MaxMetall - 15 лет опыта.',
  phone: '+996555918355',
...
export const generateMainPageMeta = () => {
  const title = `Нержавейка Бишкек | Перила, лестницы для бассейна, карнизы из нержавеющей стали MaxMetall`;
  const description = `Нержавейка в Бишкеке: производство изделий из нержавеющей стали. Перила, лестницы для бассейна, карнизы, поручни ЛОВЗ, флагштоки. MaxMetall - 15 лет опыта. ☎ +996555918355`;
  ...
  return {
    ...
    canonical,
    openGraph: {
      title: `Нержавейка Бишкек | Изделия из нержавеющей стали MaxMetall`,
      description: `Нержавейка в Бишкеке: производство изделий из нержавеющей стали. Перила, лестницы для бассейна, карнизы, поручни ЛОВЗ, флагштоки. MaxMetall - 15 лет опыта. ☎ +996555918355`,
      url: canonical,
